...
<template>
  <MainLayout module="Roles" header-module="Settings">
                  ...
                  >
                    ...
                    <li>
                      <button
                        ...
                        @click.prevent="selectAction('delete', item)"
                      >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <template v-if="formAction != 'view'">
                ...
                <div class="custom-form-input" style="margin-bottom: 1.5rem">
                  ...
                  <div class="select-all">
                    <input
                      ...
                      @click="allPermissionsChkbox = !allPermissionsChkbox"
                      :checked="allPermissionsChkbox"
                    />
                    <label for="checkbox_all" class="checkbox">All</label>
                  </div>
                  <div
                    v-for="(items, key, index) in permissions"
                    :key="index"
                  ...
                  >
                    ...
                    <div class="permissions">
                      <div
                        v-for="(permission, index) in items"
                        :key="index"
                        class="permission"
                      >
                        <input
                  ...
                  <table class="table table-bordered table-striped table-view">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <span v-for="(item, index) in role.permissions.map(i => i.name)" :key="index" class="text-capitalize">
                            {{ item }} <br>
                          </span>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <span v-if="formAction != 'view'" class="text-xs"
                >Assign permissions carefully, as they affect user access.</span
              >
